...
export default class Truck extends MyGroup {
    wheel1;
    wheel2;
    wheel3;
    wheel4;
    ...
    constructor(name, options) {
        ...
        this.wheel5 = wheel5;
        this.wheel6 = wheel6;
        this.add(wheel1, wheel2, wheel3, wheel4, wheel5, wheel6);
        this.setInner();
    ...
    addHead() {
        ...
        const materials = new Array(new THREE.MeshBasicMaterial({
            color: 0x00b8fc,
            opacity: 0.5,
            transparent: true
