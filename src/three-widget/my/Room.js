...
export default class Room extends MyGroup {
    inDoor;
    outDoor;
    ...
    addTop() {
        ...
        //创建一段弧线
        const curve = new THREE.EllipseCurve(0, 0, topLineRadius, topLineRadius, Math.PI * 0.25, Math.PI * 0.75, false, 0);
        //在弧线上取50个点
    ...
    createOpenDoorAnimation(door) {
        return gsap.to(door.scale, {
            y: 0,
            duration: 3,
            ease: "none",
            paused: true,
