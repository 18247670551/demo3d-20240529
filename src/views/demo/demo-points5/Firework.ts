...
export default class Firework extends THREE.Group{
    ...
    private readonly ball: THREE.Points

    private readonly firesMaterial: THREE.ShaderMaterial
    private readonly fires:THREE.Points
    ...
    removeSource(src: THREE.Points){
        src.clear()
        src.geometry.dispose()
        const material = src.material as THREE.Material
        material.dispose()
