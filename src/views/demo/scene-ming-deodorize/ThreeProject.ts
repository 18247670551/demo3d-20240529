...
import SimplePump, {SimplePumpOptions} from "@/three-widget/my/SimplePump"
import AcidWashPool from "@/three-widget/my/AcidWashPool"
import SpriteRectText from "@/three-widget/my/text/SpriteRectText"
import SimpleValve, {SimpleValveOptions} from "@/three-widget/my/pipe/SimpleValve"
...
/**
 * roomIndex 为车间号, 1=>水洗, 2=>预洗, 3=>生物
 * @param pumps: SimplePump[], [通道1水洗1泵, 通道1水洗2泵, 通道2水洗1泵, 通道2水洗2泵, 通道3水洗1泵, 通道3水洗2泵, 通道4水洗1泵, 通道4水洗2泵]
 * @param pipes: Pipe[], [通道1水洗1水管, 通道1水洗2水管, 通道2水洗1水管, 通道2水洗2水管, 通道3水洗1水管, 通道3水洗2水管, 通道4水洗1水管, 通道4水洗2水管]
 * @param valves: SimpleValve[], [通道1水洗1进水阀, 通道1水洗2进水阀, 通道2水洗1进水阀, 通道2水洗2进水阀, 通道3水洗1进水阀, 通道3水洗2进水阀, 通道4水洗1进水阀, 通道4水洗2进水阀]
 * @param waterPipes: Pipe[], [通道1基座进水水管, 通道2水洗基座进水水管, 通道3水洗基座进水水管, 通道4水洗基座进水水管]
 * @param waterValves: SimpleValve[], [通道1基座进水阀, 通道2水洗基座进水阀, 通道3水洗基座进水阀, 通道4水洗基座进水阀]
 */
interface ChannelDevices {
    pumps: SimplePump[],
    pipes: Pipe[],
    valves: SimpleValve[],
    baseWaterInPipe: Pipe[],
    baseWaterInValve: SimpleValve[],
}

interface ChannelSmokeComponents {
    pipes: SimplePipe[]
    valves: StrokeValve[]
}
...
export default class ThreeProject extends ThreeCore {
    ...
    //生物车间水泵基座
    private fermentPumpBaseWidth = 900
    private fermentPumpBaseHeight = 600
    private fermentPumpBaseDepth = 500

    //生物车间水泵
    private fermentPumpRadius = 150
    private fermentPumpHeight = 400


    private mainSmokePipeR = 500
    private mainSmokePipeRectR = 800
    private channelSmokePipeR = 300
    private channelSmokePipeRectR = 600

    //主排 主进 烟管道 离车间的距离
    private mainSmokePipeOffsetXOfRoomMaxX = 2500
    //主排烟管道2 主排后面接四路风机, 再汇入主排烟管道2, 离车间的距离
    private mainSmokeOutPipe2OffsetXOfRoomMaxX = 4500


    //主排管道, 离地1米, 大约就是可以摆下风机的高度, 不会使风机到地面下
    private mainSmokeOutPipeY = 900
    //主排烟管道2(风机之后, 进入酸洗之前) 离地2.5米
    private mainSmokeOutPipe2Y = 2500


    //酸洗喷淋塔
    private acidSprayTower: SprayTower | null = null
    private sprayTowerWaterFall: Rain | null = null
    private acidSprayTowerOffsetXOfRoomMaxX = 10000
    private acidSprayTowerTierRadius = 1800
    private acidSprayTowerTierHeight = 2200
    private acidSprayTowerTiers = 3

    //排烟烟囱
    private chimney: Chimney | null = null
    private chimneyOffsetXOfRoomMaxX = 17000
    private chimneyRadius = 700
    private chimneyHeight = 15000


    //供水通路公共Z坐标
    private waterOffsetZOfRoomMaxZ = 3000
    private waterPipeRectR = 200
    //主供水泵
    private waterPump1: SimplePump | null = null
    private waterPump2: SimplePump | null = null
    private waterPumpX = this.floorLength / 2 - 1000
    private waterPumpR = 400
    private waterPumpH = 1000
    private waterValveR = 100
    private waterValveH = 150
    //两个主供水泵汇合的位置
    private waterPumpsConvergeX = this.waterPumpX - 2000

    //酸洗通道公共Z坐标
    private acidWashPathZ = 1000

    //酸洗搅拌池
    private acidWashPool: AcidWashPool | null = null
    private acidWashPoolLevelText: SpriteRectText | null = null
    private acidWashPoolOffsetXOfRoomMaxX = 11000
    private acidPoolWaterInValve: SimpleValve | null = null
    private acidWashPoolLength = 4000
    private acidWashPoolWidth = 2500
    private acidWashPoolHeight = 2500
    private acidWashPoolWallThickness = 200
    private acidWashPoolWallColor = 0x666666

    //酸洗搅拌池出水水泵
    private acidWashPoolOutPump1: SimplePump | null = null
    private acidWashPoolOutPump2: SimplePump | null = null
    private acidWashPoolOutPumpOffsetXOfRoomMaxX = this.acidWashPoolOffsetXOfRoomMaxX - (this.acidWashPoolLength / 2 + 1000)

    private acidPoolOutPump1Pipe: Pipe | null = null
    private acidPoolOutPump2Pipe: Pipe | null = null

    //酸洗加药桶
    private acidBucket: Bucket | null = null
    private acidBucketLevelText: SpriteRectText | null = null
    private acidBucketX = this.floorLength / 2 - 2000
    private acidBucketRadius = 600
    private acidBucketHeight = 2000
    private topColor = 0xef5b9c
    private bottomColor = 0xef5b9c
    private flankColor = 0xed1941
    //酸洗加药桶计量泵
    private acidBucketMeteringPump: MeteringPump | null = null
    private acidBucketMeteringPumpText: SpriteRectText | null = null


    private acidWashPoolMixer: Mixer | null = null
    ...
    private fermentRows = 4
    private fermentColumns = 3
    private fermentTiers = 2
    private fermentWallColor = 0x6aab73
    private fermentTopColor = 0x6aab73

    private squareLength = 6000
    private squareHeight = 3500
    private squareWidth = 3000
    private squareThickness = 80

    private channel1Index = 1
    private channel2Index = 2
    private channel3Index = 3
    private channel4Index = 4

    private washIndex = 1
    private beforeIndex = 2
    private fermentIndex = 3
    /* endregion */


    /* region 进气 */
    private mainSmokeInPipe: SimplePipe | null = null

    private channel1In1Pipe: SimplePipe | null = null
    private channel1In2Pipe: SimplePipe | null = null
    private channel2In1Pipe: SimplePipe | null = null
    private channel2In2Pipe: SimplePipe | null = null
    private channel3In1Pipe: SimplePipe | null = null
    private channel3In2Pipe: SimplePipe | null = null
    private channel4In1Pipe: SimplePipe | null = null
    private channel4In2Pipe: SimplePipe | null = null

    private channel1In1Valve: StrokeValve | null = null
    private channel1In2Valve: StrokeValve | null = null
    private channel2In1Valve: StrokeValve | null = null
    private channel2In2Valve: StrokeValve | null = null
    private channel3In1Valve: StrokeValve | null = null
    private channel3In2Valve: StrokeValve | null = null
    private channel4In1Valve: StrokeValve | null = null
    private channel4In2Valve: StrokeValve | null = null
    /* endregion */


    /* region 排气 */
    private mainSmokeOutPipe: SimplePipe | null = null

    private channel1Out1Pipe: SimplePipe | null = null
    private channel1Out2Pipe: SimplePipe | null = null
    private channel2Out1Pipe: SimplePipe | null = null
    private channel2Out2Pipe: SimplePipe | null = null
    private channel3Out1Pipe: SimplePipe | null = null
    private channel3Out2Pipe: SimplePipe | null = null
    private channel4Out1Pipe: SimplePipe | null = null
    private channel4Out2Pipe: SimplePipe | null = null

    private channel1Out1Valve: StrokeValve | null = null
    private channel1Out2Valve: StrokeValve | null = null
    private channel2Out1Valve: StrokeValve | null = null
    private channel2Out2Valve: StrokeValve | null = null
    private channel3Out1Valve: StrokeValve | null = null
    private channel3Out2Valve: StrokeValve | null = null
    private channel4Out1Valve: StrokeValve | null = null
    private channel4Out2Valve: StrokeValve | null = null

    private mainSmokeOutPipe1: SimplePipe | null = null

    private fan1: Fan3 | null = null
    private fan2: Fan3 | null = null
    private fan3: Fan3 | null = null
    private fan4: Fan3 | null = null

    /* endregion */

    /* region 所有通道的 水泵/管道/阀门 */
    private channel1Wash1Pump: SimplePump | null = null
    private channel1Wash2Pump: SimplePump | null = null
    private channel1Before1Pump: SimplePump | null = null
    private channel1Before2Pump: SimplePump | null = null
    private channel1Ferment1Pump: SimplePump | null = null
    private channel1Ferment2Pump: SimplePump | null = null
    private channel1Wash1Pipe: Pipe | null = null
    private channel1Wash2Pipe: Pipe | null = null
    private channel1Before1Pipe: Pipe | null = null
    private channel1Before2Pipe: Pipe | null = null
    private channel1Ferment1Pipe: Pipe | null = null
    private channel1Ferment2Pipe: Pipe | null = null
    private channel1Wash1Valve: SimpleValve | null = null
    private channel1Wash2Valve: SimpleValve | null = null
    private channel1Before1Valve: SimpleValve | null = null
    private channel1Before2Valve: SimpleValve | null = null
    private channel1Ferment1Valve: SimpleValve | null = null
    private channel1Ferment2Valve: SimpleValve | null = null
    private channel1WashBaseWaterInPipe: Pipe | null = null
    private channel1WashBaseWaterInValve: SimpleValve | null = null
    private channel1BeforeBaseWaterInPipe: Pipe | null = null
    private channel1BeforeBaseWaterInValve: SimpleValve | null = null
    private channel1FermentBaseWaterInPipe: Pipe | null = null
    private channel1FermentBaseWaterInValve: SimpleValve | null = null

    private channel2Wash1Pump: SimplePump | null = null
    private channel2Wash2Pump: SimplePump | null = null
    private channel2Before1Pump: SimplePump | null = null
    private channel2Before2Pump: SimplePump | null = null
    private channel2Ferment1Pump: SimplePump | null = null
    private channel2Ferment2Pump: SimplePump | null = null
    private channel2Wash1Pipe: Pipe | null = null
    private channel2Wash2Pipe: Pipe | null = null
    private channel2Before1Pipe: Pipe | null = null
    private channel2Before2Pipe: Pipe | null = null
    private channel2Ferment1Pipe: Pipe | null = null
    private channel2Ferment2Pipe: Pipe | null = null
    private channel2Wash1Valve: SimpleValve | null = null
    private channel2Wash2Valve: SimpleValve | null = null
    private channel2Before1Valve: SimpleValve | null = null
    private channel2Before2Valve: SimpleValve | null = null
    private channel2Ferment1Valve: SimpleValve | null = null
    private channel2Ferment2Valve: SimpleValve | null = null
    private channel2WashBaseWaterInPipe: Pipe | null = null
    private channel2WashBaseWaterInValve: SimpleValve | null = null
    private channel2BeforeBaseWaterInPipe: Pipe | null = null
    private channel2BeforeBaseWaterInValve: SimpleValve | null = null
    private channel2FermentBaseWaterInPipe: Pipe | null = null
    private channel2FermentBaseWaterInValve: SimpleValve | null = null

    private channel3Wash1Pump: SimplePump | null = null
    private channel3Wash2Pump: SimplePump | null = null
    private channel3Before1Pump: SimplePump | null = null
    private channel3Before2Pump: SimplePump | null = null
    private channel3Ferment1Pump: SimplePump | null = null
    private channel3Ferment2Pump: SimplePump | null = null
    private channel3Wash1Pipe: Pipe | null = null
    private channel3Wash2Pipe: Pipe | null = null
    private channel3Before1Pipe: Pipe | null = null
    private channel3Before2Pipe: Pipe | null = null
    private channel3Ferment1Pipe: Pipe | null = null
    private channel3Ferment2Pipe: Pipe | null = null
    private channel3Wash1Valve: SimpleValve | null = null
    private channel3Wash2Valve: SimpleValve | null = null
    private channel3Before1Valve: SimpleValve | null = null
    private channel3Before2Valve: SimpleValve | null = null
    private channel3Ferment1Valve: SimpleValve | null = null
    private channel3Ferment2Valve: SimpleValve | null = null
    private channel3WashBaseWaterInPipe: Pipe | null = null
    private channel3WashBaseWaterInValve: SimpleValve | null = null
    private channel3BeforeBaseWaterInPipe: Pipe | null = null
    private channel3BeforeBaseWaterInValve: SimpleValve | null = null
    private channel3FermentBaseWaterInPipe: Pipe | null = null
    private channel3FermentBaseWaterInValve: SimpleValve | null = null

    private channel4Wash1Pump: SimplePump | null = null
    private channel4Wash2Pump: SimplePump | null = null
    private channel4Before1Pump: SimplePump | null = null
    private channel4Before2Pump: SimplePump | null = null
    private channel4Ferment1Pump: SimplePump | null = null
    private channel4Ferment2Pump: SimplePump | null = null
    private channel4Wash1Pipe: Pipe | null = null
    private channel4Wash2Pipe: Pipe | null = null
    private channel4Before1Pipe: Pipe | null = null
    private channel4Before2Pipe: Pipe | null = null
    private channel4Ferment1Pipe: Pipe | null = null
    private channel4Ferment2Pipe: Pipe | null = null
    private channel4Wash1Valve: SimpleValve | null = null
    private channel4Wash2Valve: SimpleValve | null = null
    private channel4Before1Valve: SimpleValve | null = null
    private channel4Before2Valve: SimpleValve | null = null
    private channel4Ferment1Valve: SimpleValve | null = null
    private channel4Ferment2Valve: SimpleValve | null = null
    private channel4WashBaseWaterInPipe: Pipe | null = null
    private channel4WashBaseWaterInValve: SimpleValve | null = null
    private channel4BeforeBaseWaterInPipe: Pipe | null = null
    private channel4BeforeBaseWaterInValve: SimpleValve | null = null
    private channel4FermentBaseWaterInPipe: Pipe | null = null
    private channel4FermentBaseWaterInValve: SimpleValve | null = null
     ...
     */
    createDevices(roomIndex: number) {
        ...
        const pumpOptions: SimplePumpOptions = {radius: pumpR, height: pumpH}
        ...
        const valveR = 50
        const valveH = 100
        const valveOptions: SimpleValveOptions = {radius: valveR, height: valveH}
        ...
        const waterValveOptions: SimpleValveOptions = {radius: waterValveR, height: waterValveH}
    ...
    //此方法要求必须先创建主进烟管道
    addChannelSmokeInPipeAndGetComponents(channelIndex: number) {
        const group = new THREE.Group()

        const components: ChannelSmokeComponents = {
            pipes: [],
            valves: []
        }
    ...
    //此方法要求必须先创建主排烟管道
    addChannelSmokeOutPipeAndGetComponents(channelIndex: number) {
        const group = new THREE.Group()
     ...
     */
    private createChannelWaterPipe(name: string, length1: number, length2: number) {
    ...
    private addGUI() {
        ...
        const channel1Record: Record<string, Function> = {
        ...
        const inWaterRecord: Record<string, Function> = {
        ...
        const fanRecord: Record<string, Function> = {
            "风机1运行": () => this.fan1?.run(),
            "风机2运行": () => this.fan2?.run(),
            "风机3运行": () => this.fan3?.run(),
            "风机4运行": () => this.fan4?.run(),
        ...
        const acidPathRecord: Record<string, Function> = {
    ...
    // 执行数据变化事件
    private executePoint(point: string, value: string) {
    ...
    private emitterHandler([point, value]: [point: string, value: string]) {
