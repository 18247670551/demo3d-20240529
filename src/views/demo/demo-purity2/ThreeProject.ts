...
export default class ThreeProject extends ThreeCore{
    ...
    //所有排污阀距离地板正Z边缘距离
    private drainOffsetZOfFloorMax: number = 2000
    ...
    //水泵位置, 产水池 原水池 相同
    private pumpX = -(this.floorLength / 2 - 4000)


    //产水通路起始点X, 即 产水池X
    private purePathStartX = -(this.floorLength / 2 - 1000)
    //Z轴距离碱洗通路5米远
    private purePathZ = this.sodaPathZ + 5000
    //产水池尺寸
    private purePoolLength = 1500
    private purePoolWidth = 4000
    private purePoolHeight = 2000
    //产水池产水通道1
    private pureChannel1Z = this.purePathZ - this.purePoolWidth / 4
    private pureChannel2Z = this.purePathZ + this.purePoolWidth / 4
    //产水池液体颜色(清水 蓝色)
    ...
    //距离原水通路5米远
    private sewageZ = this.purePathZ + 6000
    //原水池尺寸
    ...
    private sandTankX = this.pumpX + 5000

    //气罐
    private airTank: Tank | null = null
    private airTankX = 2000
    ...
    //反洗泵1
    private filterWashChannel1Pump: Pump | null = null
    //反洗泵2
    private filterWashChannel2Pump: Pump | null = null

    private filterWashChannel1LowPipe1: Pipe | null = null
    private filterWashChannel2LowPipe1: Pipe | null = null

    private filterWashChannel1HighPipe1: Pipe | null = null
    private filterWashChannel2HighPipe1: Pipe | null = null

    private washChannel1AndWashChannel2CommonPipe1: Pipe | null = null

    //产水管道
    private pureOutPipe: Pipe | null = null
    //反洗阀
    ...
    private sandTankInPipe: Pipe | null = null
    private sandTankOutPipe1: Pipe | null = null
    private sandTankWashInPipe: Pipe | null = null
    //原水流量计
    private sewageFlowMeter: FlowMeter | null = null
    private sewageFlowMeterText: SpriteRectText | null = null
    //砂罐进水压力表
    private sandTankInPiezoMeter: PiezoMeter | null = null
    //砂罐进水压力表显示
    private sandTankInPiezoMeterText: SpriteRectText | null = null
    //砂罐出水压力表
    private sandTankOutPiezoMeter: PiezoMeter | null = null
    //砂罐出水压力表显示
    private sandTankOutPiezoMeterText: SpriteRectText | null = null
    //砂罐进水阀
    private sewageSandTankInValve: StrokeValve | null = null
    //砂罐出水阀
    private sankTankOutValve: StrokeValve | null = null
    //砂罐反洗进水阀
    private sandTankWashInValve: StrokeValve | null = null
    //砂罐上排阀
    private sankTankUpDrainValve: StrokeValve | null = null
    //砂罐下排阀
    private sankTankDownDrainValve: StrokeValve | null = null

    //超滤进水压力表
    private filterInPiezoMeter: PiezoMeter | null = null
    //超滤进水压力表显示
    private filterInPiezoMeterText: SpriteRectText | null = null

    //超滤进水阀
    private filterInValve: StrokeValve | null = null
