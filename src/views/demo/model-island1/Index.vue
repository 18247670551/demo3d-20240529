...
function init() {
  ...
  const water = new Water(waterGeo, {
    ...
    scale: 2,
    flowMap: getTextureLoader().load("/demo/model-island1/Water_1_M_Flow.jpg"),
    normalMap0: getTextureLoader().load("/demo/model-island1/Water_1_M_Normal.jpg"),
    normalMap1: getTextureLoader().load("/demo/model-island1/Water_2_M_Normal.jpg"),
  })
  // 水面旋转至水平
  ...
  const skyMat = new THREE.MeshBasicMaterial({
    map: getTextureLoader().load("/demo/model-island1/sky.jpg")
  })
  ...
  // 添加小岛模型
  getDracoGltfLoader().load("/demo/model-island1/island.glb", (gltf) => {
