...
export default class ThreeProject extends ThreeCore {
    ...
    private readonly randomBuildingTexturesArr = [
        "/demo/shanghai/building1.jpg",
        "/demo/shanghai/building2.jpg",
        "/demo/shanghai/building3.jpg",
        "/demo/shanghai/building4.jpg",
        "/demo/shanghai/building5.jpg",
        "/demo/shanghai/building6.jpg",
        "/demo/shanghai/building7.jpg",
        "/demo/shanghai/building8.jpg",
        "/demo/shanghai/building9.jpg",
        "/demo/shanghai/building10.jpg"
    ]
    ...
    constructor(dom: HTMLElement) {
        ...
        const lensflareTexture0 = new TextureLoader().load('/demo/shanghai/lensflare/lensflare0.png')
        const lensflareTexture3 = new TextureLoader().load('/demo/shanghai/lensflare/lensflare3.png')
        // 六边形
        const lensflareTextureHexAngle = new TextureLoader().load('/demo/shanghai/lensflare/hexangle.png')
    ...
    private addShanghaiTower() {
        ...
        const texture = new THREE.TextureLoader().load("/demo/shanghai/building5.jpg")
    ...
    private addJinmaoTower() {
        ...
        const texture = new THREE.TextureLoader().load("/demo/shanghai/building5.jpg")// 颜色贴图
        texture.colorSpace = THREE.SRGBColorSpace
    ...
    private getJinmaoTowerTop() {
        ...
        const texture = new THREE.TextureLoader().load("/demo/shanghai/JMtowertop.jpg")// 颜色贴图
        texture.colorSpace = THREE.SRGBColorSpace
        texture.wrapS = texture.wrapT = THREE.RepeatWrapping // 水平和竖直方向重复贴图
    ...
    private getGlobalFinancialCenterBottom() {
        ...
        const texture = this.loader.load("/demo/shanghai/JMtowerbody.jpg")
        texture.colorSpace = THREE.SRGBColorSpace
        texture.wrapS = texture.wrapT = THREE.RepeatWrapping
        texture.repeat.set(0.5, 1)
