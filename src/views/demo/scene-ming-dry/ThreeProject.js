...
export default class ThreeProject extends ThreeCore {
    ...
    constructor(dom) {
        ...
        this.temperature1 = temperatures[0];
        this.temperature2 = temperatures[1];
        this.temperature3 = temperatures[2];
        this.temperature4 = temperatures[3];
        this.temperature5 = temperatures[4];
        this.temperature6 = temperatures[5];
        this.temperature7 = temperatures[6];
        this.temperature8 = temperatures[7];
    ...
    addAndGetTemperatures() {
        ...
        this.scene.add(t1, t2, t3, t4, t5, t6, t7, t8);
        return [
            t1,
            t2,
            t3,
    ...
    addHeatingFan() {
        ...
        this.scene.add(heatingFan1, heatingFan2, heatingFan3, heatingFan4, heatingFan5, heatingFan6);
        return [
            heatingFan1,
            heatingFan2,
            heatingFan3,
    ...
    addCirculatingFan() {
        ...
        this.scene.add(circulatingFan1, circulatingFan2, circulatingFan3, circulatingFan4, circulatingFan5, circulatingFan6, circulatingFan7, circulatingFan8);
        return [
            circulatingFan1,
            circulatingFan2,
            circulatingFan3,
    ...
    points = {
        ...
        "1368834975129944070": (value) => {
            //console.log("照明自动运行")
        },
        "1368834975129944071": (value) => {
            //console.log("一门自动开")
        },
        "1368834975129944072": (value) => {
            //console.log("二门自动开")
        },
        "1368834975129944073": (value) => {
            //console.log("故障提示")
        },
        "1368834975129944077": (value) => {
            //console.log("到达计时温度")
        },
        "1368834975129944078": (value) => {
            //console.log("倒计时开始")
        },
        "1368834975129944079": (value) => {
            //console.log("延时开闭风机和开门")
        },
        "1368834975129944080": (value) => {
            //console.log("轮流加热阶段")
        },
        "1368834975129944082": (value) => {
            //console.log("1号温度故障")
        },
        "1368834975129944083": (value) => {
            //console.log("2号温度故障")
        },
        "1368834975129944084": (value) => {
            //console.log("3号温度故障")
        },
        "1368834975129944085": (value) => {
            //console.log("4号温度故障")
        },
        "1368834975129944086": (value) => {
            //console.log("5号温度故障")
        },
        "1368834975129944087": (value) => {
            //console.log("6号温度故障")
        },
        "1368834975129944088": (value) => {
            //console.log("7号温度故障")
        },
        "1368834975129944089": (value) => {
            //console.log("8号温度故障")
        },
        "1368834975129944090": (value) => {
            //console.log("9号温度故障")
        },
        "1368834975129944091": (value) => {
            //console.log("10号温度故障")
        },
        "1368834975129944092": (value) => {
            //console.log("温度过高停机")
        },
        "1368834975129944093": (value) => {
            //console.log("湿度1故障")
        },
        "1368834975129944094": (value) => {
            //console.log("湿度2故障")
        },
        "1368834975129944095": (value) => {
            //console.log("柜门急停")
        },
        "1368834975129944096": (value) => {
            //console.log("外部急停")
        },
        "1368834975129944097": (value) => {
            //console.log("烟雾报警信号")
        },
        "1368834975129944098": (value) => {
            //console.log("故障输出")
        },
        "1368834975129944099": (value) => {
            //console.log("故障消音")
        },
        "1368834975129944100": (value) => {
            //console.log("相序错误")
        },
        "1368834975129944101": (value) => {
            //console.log("油位过低")
        },
        "1368834975129944102": (value) => {
        ...
        //     //console.log("云端温度10")
        // },
        "1368834975129944145": (value) => {
            //console.log("云端湿度1");
            this.humidity1.setValue(value);
        },
        "1368834975129944146": (value) => {
            //console.log("云端湿度2");
