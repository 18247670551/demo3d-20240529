...
export default class ThreeProject extends ThreeCore {
    ...
    private readonly points1: THREE.Points
    private readonly points2: THREE.Points
    private readonly points3: THREE.Points
    ...
    constructor(dom: HTMLElement) {
        ...
        this.points3 = this.addAndGetPoints("/demo/my/wash/smoke1.png", 10000)
    }
    ...
    private addAndGetPoints(texturePath: string, count: number, size = 0.5) {
