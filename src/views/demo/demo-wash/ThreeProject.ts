...
export default class ThreeProject extends ThreeCore{
    ...
    private truckBodyWash: TruckBodyWash
    private truckBottomWash: TruckBottomWash

    private topLeftWashGun: WashGun
    private topMiddleWashGun: WashGun
    private topRightWashGun: WashGun
