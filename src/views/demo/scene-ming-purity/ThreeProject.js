...
export default class ThreeProject extends ThreeCore {
    ...
    //化学通路起始点X, 即 酸加药桶X
    chemicalPathStartX = this.acidPathStartX;
    //化学通路中心Z
    chemicalPathZ = this.sodaPathZ + 1500;
    chemicalMeteringPumpX = this.acidPathStartX + 1000;
    //水泵位置, 产水池 原水池 相同
    pumpX = -(this.floorLength / 2 - 5000);
    //产水通路起始点X, 即 产水池X
    purePathStartX = -(this.floorLength / 2 - 1000);
    //Z轴距离化学洗通路5米远
    purePathZ = this.chemicalPathZ + 5000;
    //产水池尺寸
    purePoolLength = 1500;
    purePoolWidth = 4000;
    purePoolHeight = 2000;
    //产水池产水通道1
    pureChannel1Z = this.purePathZ - this.purePoolWidth / 2 + this.purePoolWidth / 5;
    pureChannel2Z = this.purePathZ + this.purePoolWidth / 5;
    //产水池液体颜色(清水 蓝色)
    purePoolLiquidColor = 0x33a3dc;
    //原水通路起始点X, 即 原水池X
    sewageStartX = -(this.floorLength / 2 - 1000);
    //距离原水通路5米远
    sewageZ = this.purePathZ + 5000;
    //原水池尺寸
    ...
    chemicalBucket = null;
    //液位显示
    chemicalBucketLevelText = null;
    //计量泵
    chemicalMeteringPump = null;
    //流量显示
    chemicalMeteringPumpText = null;
    chemicalPathPipe1 = null;
    acidAndSodaAndChemicalCommonPathPipe1 = null;
    //原水池(污水池)
    sewagePool = null;
    //原水池液位显示
    ...
    sewageChannel1AndChannel2CommonPipe1 = null;
    //原水流量计
    sewageFlowMeter = null;
    sewageFlowMeterText = null;
    //原水压力表
    sewagePiezoMeter = null;
    sewagePiezoMeterText = null;
    //原水阀
    sewageValve = null;
    //产水池(净化水)
    purePool = null;
    ...
    //反洗泵1
    washChannel1Pump = null;
    //反洗泵2
    washChannel2Pump = null;
    washChannel1LowPipe1 = null;
    washChannel2LowPipe1 = null;
    washChannel1HighPipe1 = null;
    washChannel2HighPipe1 = null;
    washChannel1AndChannel2CommonPipe1 = null;
    //产水管道
    outPurePipe = null;
    //反洗阀
    washValve = null;
    ...
    //超滤反洗主管道
    filterWashMainPipe = null;
    //超滤超滤产水主管道
    filterPureOutPipe = null;
    airTank = null;
    airTankX = 3000;
