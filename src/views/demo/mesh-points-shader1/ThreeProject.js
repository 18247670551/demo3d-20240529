...
export default class ThreeProject extends ThreeCore {
    ...
    addPointsAndGetMaterial() {
        ...
        const texture = getTextureLoader().load('/demo/mesh-points-shader1/1.png');
        const texture1 = getTextureLoader().load('/demo/mesh-points-shader1/2.png');
        const texture2 = getTextureLoader().load('/demo/mesh-points-shader1/3.png');
