...
export default class ThreeProject extends ThreeCore {
    ...
    constructor(dom: HTMLElement) {
        ...
        // 镜头光晕
        const textureFlare0 = getTextureLoader().load("/demo/model-island2/lensflare0.png")
        const textureFlare1 = getTextureLoader().load("/demo/model-island2/lensflare1.png")
    ...
    private createWater(){
        const waterTexture = getTextureLoader().load('/demo/model-island2/waternormals.jpg', texture => {
    ...
    private addIsland(){
        ...
        loader.load("/demo/model-island2/island.glb", gltf => {
    ...
    private addBird(){
        const loader = new GLTFLoader()
        loader.load("/demo/model-island2/flamingo.glb", gltf => {
