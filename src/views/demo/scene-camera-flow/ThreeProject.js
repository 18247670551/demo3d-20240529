...
export default class ThreeProject extends ThreeCore {
    ...
    constructor(dom) {
        ...
        anchorParams.map(param => {
            const anchor = new THREE.Mesh(pathPointGeo, new THREE.MeshBasicMaterial({ color: param.color }));
        ...
        const carCamera = new THREE.PerspectiveCamera(this.options.cameraOptions.fov, this.dom.clientWidth / this.dom.clientHeight, this.options.cameraOptions.near, this.options.cameraOptions.far);
