...
export default class ThreeProject extends ThreeCore {
    ...
    private readonly meshs: THREE.Mesh[] = []

    private defaultMeshColor = new THREE.Color(0x00ffff)
    private readonly currentMeshColor = new THREE.Color(0xff0000)
    private currentMesh: THREE.Mesh | null = null
    private backupMeshColor: THREE.Color | null = null
