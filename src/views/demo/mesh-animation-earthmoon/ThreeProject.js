...
export default class ThreeProject extends ThreeCore {
    ...
    clouds;
    curve;
    earthRadius = 10; // 月球公转半径
    earthLoopTime = 15 * 1000; // 地球自转一圈的时间
    cloudsLoopRadius = 11; // 云层半径
    cloudsLoopXTime = 24 * 1000; // 云层 X轴 转一圈
    cloudsLoopYTime = 30 * 1000; // 云层 Y轴 转一圈
    moonLoopTime = 20 * 1000; // 月球公转
    moonRadius = 4; // 月球公转半径
    moonLoopRadius = 40; // 月球公转半径
    constructor(dom) {
        super(dom, {
            cameraOptions: {
                fov: 75,
        ...
        const earth = new THREE.Mesh(new THREE.SphereGeometry(this.earthRadius, 64, 64), new THREE.MeshStandardMaterial({
