...
export default class ThreeProject extends ThreeCore {
    ...
    waterPipeR = 70;
    waterPipeRectR = 200;
    waterPipeOffsetSquareTop = 500;
    mainSmokePipeR = 500;
    mainSmokePipeRectR = 800;
    channelSmokePipeR = 400;
    channelSmokePipeRectR = 600;
    mainSmokePipeOffsetXOfRoom = 2500;
    mainOutSmokePipeOffsetYOfRoom = 1200;
    mainOutSmokePipeOffsetYOfFloor = 1000;
    roomOptions = {
        squareLength: 8000,
        squareHeight: 5000,
        squareWidth: 12000,
    ...
    roomOffsetFloorMinX = 4000;
    fanOffsetZ0 = 2000;
    fanOffsetXOfMainOutSmokePipe = 2000;
    pumpBaseLength = 1800;
    pumpBaseHeight = 1000;
    pumpBaseWidth = 800;
    cabinetOffsetXOfFloorMaxX = -5000;
    cabinetX = this.floorLength / 2 + this.cabinetOffsetXOfFloorMaxX;
    cabinetZ = 5000;
    /* endregion */
    /* region three实体 */
    room = null;
    mainInSmokePipe = null;
    mainOutSmokePipe = null;
    tier1InPipe = null;
    tier2InPipe = null;
    smokeInFlowMeter = null;
    smokeInFlowMeterText = null;
    smokeInPiezoMeter = null;
    smokeInPiezoMeterText = null;
    outChannel1Pipe = null;
    outChannel2Pipe = null;
    fan1 = null;
    fan2 = null;
    mainOutSmokePipe2 = null;
    chimney = null;
    beforeWash1Pump = null;
    beforeWash2Pump = null;
    ferment1Pump = null;
    ferment2Pump = null;
    ferment3Pump = null;
    ferment4Pump = null;
    waterValve = null;
    //液位显示
    liquidLevelSensorText = null;
    //温度显示
    temperatureSensorText = null;
    //ph显示
    phSensorText = null;
    //电导率显示
    conductivitySensorText = null;
    //风机频率显示
    fanFrequencyText = null;
    /* endregion */
    constructor(dom) {
        super(dom, {
            cameraOptions: {
