...
export default class ThreeProject extends ThreeCore {
    ...
    addSky() {
        getCubeTextureLoader().setPath('/demo/scene-shanghai/skybox/').load(['left.jpg', 'right.jpg', 'top.jpg', 'bottom.jpg', 'front.jpg', 'back.jpg'], texture => {
    ...
    addOrientalPearl() {
        ...
        bottom.add(cylinder1, cylinder2, bottom_cylinder, little_bottom_cylinder1, little_bottom_cylinder2, little_bottom_cylinder3);
        // 2. 中间部分 三个圆柱 + 圆球
    ...
    getTorus(radius, tube, radialSegments, tubularSegments, potionsY) {
    ...
    addBuilding() {
        ...
        for (let i = 0; i < this.randomBuildingPositionsArr.length; i++) {
            ...
            mesh.position.set(this.randomBuildingPositionsArr[i].x, this.randomBuildingPositionsArr[i].y + h / 2, this.randomBuildingPositionsArr[i].z);
            mesh.castShadow = true;
            mesh.receiveShadow = true;
            buildings.add(mesh);
        }
