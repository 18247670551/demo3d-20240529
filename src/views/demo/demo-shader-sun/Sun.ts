...
import cubeVertexShader from '@/views/demo/demo-shader-sun/shader/noise/vertexShader.glsl'
import cubeFragmentShader from '@/views/demo/demo-shader-sun/shader/noise/fragmentShader.glsl'
...
export default class Sun extends THREE.Group {
    ...
    update(renderer: THREE.WebGLRenderer, elapsedTime: number) {
