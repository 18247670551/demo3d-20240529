...
export default class ThreeProject extends ThreeCore{
    ...
    private readonly dropCount: Ref<number>
    ...
    // 下落的水滴用一个组管理
    private readonly drops: THREE.Group
    private count = 0


    constructor(dom: HTMLElement, dropCount: Ref<number>) {
    ...
    private addLeftGrassLand(mat: THREE.Material) {
    ...
    private addRightGrassLand(mat: THREE.Material) {
    ...
    private addRiverBed(mat: THREE.Material) {
    ...
    private addRiver(mat: THREE.Material) {
    ...
    private addBridge() {
        ...
        const woodMaterial: THREE.MeshLambertMaterial = new THREE.MeshLambertMaterial({color: 0xA98F78})
        ...
        group.add(
            pole1, this.customReceiveShow(pole1, 0.2),
            pole2, this.customReceiveShow(pole2, 0.2),
            pole3, this.customReceiveShow(pole3, 0.2),
            pole4, this.customReceiveShow(pole4, 0.2),
        )
        ...
        group.add(
            crossBar1, this.customReceiveShow(crossBar1, 0.2),
            crossBar2, this.customReceiveShow(crossBar2, 0.2),
        )
    ...
    // 自定义阴影材质
    private customReceiveShow(mesh: THREE.Mesh, opacity: number) {
