...
export default class ThreeProject extends ThreeCore {
    ...
    cubes = [];
    hitSound = new Audio("/demo/scene-physics/hit.wav");
    constructor(dom) {
        super(dom, {
            cameraOptions: {
                fov: 75,
        ...
        // 地面
        const floor = new THREE.Mesh(new THREE.PlaneGeometry(20, 20), new THREE.MeshStandardMaterial({ side: THREE.DoubleSide }));
    ...
    createCube(material) {
        ...
        cubeBody.applyForce(new CANNON.Vec3(1, 0, 0), // 施加力大小和方向
