...
import door_alphaPic from "@/views/demo/mesh-texture-door/texture/door/alpha.jpg";
import door_ambientOcclusionPic from "@/views/demo/mesh-texture-door/texture/door/ambientOcclusion.jpg";
import door_colorPic from "@/views/demo/mesh-texture-door/texture/door/color.jpg";
import door_heightPic from "@/views/demo/mesh-texture-door/texture/door/height.jpg";
import door_metalnessPic from "@/views/demo/mesh-texture-door/texture/door/metalness.jpg";
import door_normalPic from "@/views/demo/mesh-texture-door/texture/door/normal.jpg";
import door_roughnessPic from "@/views/demo/mesh-texture-door/texture/door/roughness.jpg";
...
export default class ThreeProject extends ThreeCore {
    ...
    constructor(dom) {
        ...
        const floor = new THREE.Mesh(new THREE.CircleGeometry(floorRadius), new THREE.MeshStandardMaterial({
            color: "#717e05",
