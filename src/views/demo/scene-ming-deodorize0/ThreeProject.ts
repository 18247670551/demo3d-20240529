...
export default class ThreeProject extends ThreeCore {
    ...
    private waterPipeRadius = 80
    private waterPipeRectRadius = 200
    private smokePipeRadius = 500
    private smokePipeRectRadius = 1000

    //生物车间
    private room: DeodorizeRoom
    private squareLength = 6000
    private squareHeight = 6000
    private squareWidth = 8000
    private squareThickness = 80
    private windowHoleRadius = 400
    private inHoleRadius = 500
    private roomX = 3000
    private roomY = 0

    //喷淋塔
    private sprayTower: SprayTower
    private sprayTowerTiersRadius = 1800
    private sprayTowerTierHeight = 2200
    private sprayTowerTiers = 3
    private sprayTowerX = -Math.round(this.floorLength / 2 - 2000)

    //烟囱
    private chimney: Chimney
    private chimneyX = this.floorLength / 2 - 1000
    private chimneyY = 0

    private smokePipe1: SmokePipe

    private fan: Fan1
    private fanX = this.floorLength / 2 - 6000
    private fanY = 1200
    private fanZ = 0


    private fermentRows = 1
    private fermentColumns = 2
    private fermentTiers = 1
    ...
    private addAndGetSmokePipe1() {
        ...
        const smokePipe1 = new SmokePipe(
            "生物塔烟雾管道入口",
            {
