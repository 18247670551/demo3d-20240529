...
onMounted(() => {
  new ShaderProgram(wavesRef.value)
})
...
class ShaderProgram {
  ...
  resize() {
    ...
    const gl = this.gl
    const width = (this.width = dom.offsetWidth)
    const height = (this.height = dom.offsetHeight)
  ...
  createTexture() {
    ...
    const imageBase64 = 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAACAAAAAgCAMAAABEpIrGAAAAb1BMVEUAAAD' +
        '///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////' +
